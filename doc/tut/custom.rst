...
which you, the user, might need a little different. Also, the refinement
...
Nicessa lets you select some values from the columns you want to analyse, e.g. 
...
The possibilities of plot-making in Nicessa are pretty interesting,
...
Your script can make use of the work Nicessa has done on selecting files,
...
The Gnu R scripts Nicessa uses are pretty trivial, but here is an example
nonetheless:
